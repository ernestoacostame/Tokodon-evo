    ...
    contentItem: PostLayout {
        ...
        Loader {
            sourceComponent: Item {
                implicitHeight: attachmentGridInner.implicitHeight + Kirigami.Units.smallSpacing * 2
                implicitWidth: attachmentGridInner.implicitWidth
        ...
        RowLayout {
            ...
            Layout.fillWidth: true
            spacing: shouldExpand ? 0 : Kirigami.Units.gridUnit
            ...
            InteractionButton {
                ...
                tooltip: {
                    if (root.visibility === Post.Direct) {
                        ...
                        return i18nc("Share a post", "Boost (hold for options)");
                    }
                }
                ...
                onPressAndHold: boostMenu.popup(boostButton)
                ...
                QQC2.Menu {
                    ...
                    QQC2.MenuItem {
                        icon.name: "boost"
                        text: root.reblogged ? i18nc("@action:inmenu Undo boosting a post", "Undo Boost") : i18nc("@action:inmenu Boost a post", "Boost")
                        onTriggered: root.timelineModel.actionRepeat(timelineModel.index(root.index, 0))
                    }
                    QQC2.MenuItem {
                        icon.name: "format-text-blockquote-symbolic"
                        text: i18nc("@action:inmenu Quote a post", "Quote")
