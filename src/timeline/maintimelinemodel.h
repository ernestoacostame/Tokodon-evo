...
class MainTimelineModel : public TimelineModel
{
    ...
    Q_PROPERTY(bool newPostsAvailable READ newPostsAvailable NOTIFY newPostsAvailableChanged)
...
public:
    ...
    Q_INVOKABLE void checkForNewPosts();
    [[nodiscard]] bool newPostsAvailable() const;
    Q_INVOKABLE void clearNewPostsAvailable();
...
private:
    ...
    bool m_newPostsAvailable = false;
    bool m_checkingForNewPosts = false;
